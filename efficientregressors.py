...
class GaussianProcessRegressor: 
    ...
    def update_data(self, x, y):
        ...
        if self.x_vect is None:
            ...
            self.K_matrix = np.array([[1 + self.sigma_process]])
    ...
    def load_data(self, x, y):
        ...
        self.K_matrix = kernel_rbf(self.x_vect, self.x_vect, self.kernel_L) + self.sigma_process * np.eye(n)
        self.K_matrix_inv = np.linalg.inv(self.K_matrix)
    ...
    def compute(self, x):
        ...
        for i in range(n):
            ...
            sigma[i] = 1 - K_star.T @ self.K_matrix_inv @ K_star
